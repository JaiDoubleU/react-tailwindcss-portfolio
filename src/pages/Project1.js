                ...
                <div className="mt-10 ">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 sm:gap-10 mt-12">
                        <div className="mb-10 sm:mb-0 {project.id} h-full">
                            <img className="rounded-xl cursor-pointer shadow-lg sm:shadow-none h-full" src={rfxDesktopImage1} alt="" />
                        </div>
                        <div className="mb-10 sm:mb-0 {project.id} h-full">
                            <img className="rounded-xl cursor-pointer shadow-lg sm:shadow-none h-full" src={rfxDesktopImage2} alt="" />
                        </div>
                        <div className="mb-10 sm:mb-0 {project.id}">
                            <img className="rounded-xl cursor-pointer shadow-lg sm:shadow-none h-full" src={rfxDesktopImage3} alt="" />
                        </div>
                    </div>
                    ...
                    <div className="block sm:flex gap-0 sm:gap-10 mt-14">
                        <div className="w-full sm:w-1/3 text-left">
                            <div className="mb-7">
                                <p className="font-general-regular text-2xl font-semibold text-zinc-700 dark:text-zinc-200 mb-2">About the Client</p>
                                <ul className="leading-loose">
                                    <li className="font-general-regular text-zinc-700 dark:text-zinc-200"><span>Name: </span><a href="#nogo;" className="" aria-label="Project Website and Phone">Private</a></li>
                                    <li className="font-general-regular text-zinc-700 dark:text-zinc-200"><span>Deliverable: </span><a href="#nogo;" className="" aria-label="Project Website and Phone">An Interactive Mockup designed in Figma</a></li>
                        ...
                        <div className="w-full sm:w-2/3 text-left mt-10 sm:mt-0">
                            ...
                            <p className="font-general-regular text-zinc-700 dark:text-zinc-200 text-2xl font-bold mb-7">The Challenge</p>
                            <p className="font-general-regular mb-5 text-lg text-zinc-700 dark:text-zinc-200">
                            ...
                            <p className="font-general-regular text-zinc-700 dark:text-zinc-200 text-2xl font-bold mb-7">The Result</p>
                            <p className="font-general-regular mb-5 text-lg text-zinc-700 dark:text-zinc-200">
