...
import Project1Bio from '../components/projects/Project1Bio';
            ...
            {/* <Project1Provider>Project 1</Project1Provider> */}
                ...
                <div class="mt-10 ">
                    ...
                    <p class="font-general-medium text-left text-3xl sm:text-4xl font-bold text-zinc-800 dark:text-zinc-200 mt-6 mb-7">
                        Procurement Document Management Design</p>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 sm:gap-10 mt-12">
                        <div class="mb-10 sm:mb-0 {project.id} h-full"><img src="/static/media/rfxMockup1DesktopIPad.a0ba9b897e44e2a80362.png" class="rounded-xl cursor-pointer shadow-lg sm:shadow-none h-full" alt="Request Document Management Design" />
                        </div>
                        <div class="mb-10 sm:mb-0 {project.id} h-full"><img src="/static/media/rfxMockup2DesktopIPad.b8d8457ed9788f62d916.png" class="rounded-xl cursor-pointer shadow-lg sm:shadow-none h-full" alt="Request Document Management Design" />
                        </div>
                        <div class="mb-10 sm:mb-0 {project.id}"><img src="/static/media/rfxMockup3DesktopIPhone.38f33c78d096f3cd8b18.png" class="rounded-xl cursor-pointer shadow-lg sm:shadow-none h-full" alt="Request Document Management Design" />
                        </div>
                    </div>
